...
-- ----------------------------
BEGIN;
INSERT INTO `sys_route_conf` VALUES ('1', '工作流管理模块', 'martin-activiti', '[{\"args\": {\"_genkey_0\": \"/act/**\"}, \"name\": \"Path\"}]', '[]', 'lb://martin-activiti', '0', '2019-01-17 16:42:50', '2019-01-17 16:44:07', '0'), ('2', '认证中心', 'martin-auth', '[{\"args\": {\"_genkey_0\": \"/auth/**\"}, \"name\": \"Path\"}]', '[{\"args\": {}, \"name\": \"ValidateCodeGatewayFilter\"}, {\"args\": {}, \"name\": \"PasswordDecoderFilter\"}]', 'lb://martin-auth', '0', '2019-01-17 16:42:50', '2019-01-17 16:44:09', '0'), ('3', '代码生成模块', 'martin-codegen', '[{\"args\": {\"_genkey_0\": \"/gen/**\"}, \"name\": \"Path\"}]', '[]', 'lb://martin-codegen', '0', '2019-01-17 16:42:50', '2019-01-17 16:44:10', '0'), ('4', '定时任务模块', 'martin-daemon', '[{\"args\": {\"_genkey_0\": \"/daemon/**\"}, \"name\": \"Path\"}]', '[]', 'lb://martin-daemon', '0', '2019-01-17 16:42:50', '2019-01-17 16:44:12', '0'), ('5', '分布式事务模块', 'martin-tx-manager', '[{\"args\": {\"_genkey_0\": \"/tx/**\"}, \"name\": \"Path\"}]', '[]', 'lb://martin-tx-manager', '0', '2019-01-17 16:42:50', '2019-01-17 16:44:14', '0'), ('6', '通用权限模块', 'martin-upms-biz', '[{\"args\": {\"_genkey_0\": \"/admin/**\"}, \"name\": \"Path\"}]', '[{\"args\": {\"key-resolver\": \"#{@remoteAddrKeyResolver}\", \"redis-rate-limiter.burstCapacity\": \"20\", \"redis-rate-limiter.replenishRate\": \"10\"}, \"name\": \"RequestRateLimiter\"}, {\"args\": {\"name\": \"default\", \"fallbackUri\": \"forward:/fallback\"}, \"name\": \"Hystrix\"}]', 'lb://martin-upms-biz', '0', '2019-01-17 16:42:50', '2019-01-17 16:44:16', '0'), ('7', '工作流长链接支持1', 'martin-activiti-ws-1', '[{\"args\": {\"_genkey_0\": \"/act/ws/info\"}, \"name\": \"Path\"}]', '[]', 'lb://martin-activiti', '0', '2019-01-17 16:42:50', '2019-01-17 17:55:07', '0'), ('8', '工作流长链接支持2', 'martin-activiti-ws-2', '[{\"args\": {\"_genkey_0\": \"/act/ws/**\"}, \"name\": \"Path\"}]', '[]', 'lb:ws://martin-activiti', '100', '2019-01-17 16:42:50', '2019-01-17 17:55:11', '0');
COMMIT;
