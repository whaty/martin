              ...
              <FormItem {...formItemLayout}>
                {getFieldDecorator('id', {
                  initialValue: item.id,
                            ...
                            <FormItem label='页面元素名称' hasFeedback {...formItemLayout}>
                ...
                <FormItem label='权限编码，以element_开头' hasFeedback {...formItemLayout}>
                ...
                <FormItem label='页面元素路径' hasFeedback {...formItemLayout}>
