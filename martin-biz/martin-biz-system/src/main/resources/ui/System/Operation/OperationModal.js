              ...
              <FormItem {...formItemLayout}>
                {getFieldDecorator('id', {
                  initialValue: item.id,
                            ...
                            <FormItem label='操作名称' hasFeedback {...formItemLayout}>
                ...
                <FormItem label='权限编码，以operation_开头' hasFeedback {...formItemLayout}>
                ...
                <FormItem label='父操作id' hasFeedback {...formItemLayout}>
