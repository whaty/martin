          ...
          <AntModal title={title} {...modalProps} onOk={this.handleOk}>
            <Form  layout="horizontal">
              <FormItem {...formItemLayout}>
                ...
                <FormItem label='权限编码，以menu_开头' hasFeedback {...formItemLayout}>
                  {getFieldDecorator('authority', {
                    initialValue: item.authority,
                    rules: [
                      {
                        required: true,
                      },
                ...
                <FormItem label='前端URL' hasFeedback {...formItemLayout}>
                ...
                <FormItem label='父菜单ID' hasFeedback {...formItemLayout}>
                ...
                <FormItem label='前端组件' hasFeedback {...formItemLayout}>
                ...
                <FormItem label='排序值' hasFeedback {...formItemLayout}>
